...
const AboutUs = () => {
  return (
    <div style={{
      ...
      <div className='pt-10 bg-[#cccccc]  bg-opacity-40'>
        <SectionTitle
          subHeading={"---About Us---"}
          heading={"Our Mission"}
        ></SectionTitle>
      </div>
      <div className='md:flex justify-center items-center bg-[#d3d3d3] bg-opacity-50 gap-16 pb-20 pt-10 px-8 lg:px-28'>
        <div>
        ...
        <div className='space-y-4 text-center md:text-start mt-8 md:mt-0'>
          ...
          <p className='text-black'>
            <span className='text-[#1e4b57] font-extrabold'>WE WORK TO : </span>
          ...
          <p  className='text-black'>
          <span className='text-[#1e4b57] font-extrabold'>WE HAVE : </span>
